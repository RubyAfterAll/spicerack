...
#
#     def do_a_thing
#       fatal! SomeTerribleThing, "Something terrible always happens when you do a thing!", user: @user
#     end
#   end
# end
#
# describe "#do_a_thing" do
#   include_examples "an instrumented fatal exception", SomeTerribleThing do
